...
<%
    ...
    try {
        hotels = service.getHotels("Toronto"); // Fetch the list of hotels from your database
...
<script>
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
            zoom: 10,
            center: {lat: 43.6532, lng: -79.3832} // Toronto's latitude and longitude
        });
